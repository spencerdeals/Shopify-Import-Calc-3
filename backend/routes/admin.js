...
const { saveScrape, loadScrapeByKey, getCalibration, setCalibration, listQuotes } = require('../utils/db');
...
router.get('/ping', (req, res) => {
  const oceanRate = Number(process.env.OCEAN_RATE_PER_FT3 || 20);
...
router.get('/quotes', requireAdminKey, async (req, res) => {
  try {
